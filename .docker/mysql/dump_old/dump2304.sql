...
INSERT INTO `apis` (`id`, `api`, `fields`) VALUES
(1,	'/site/form',	''),
(2,	'/test/qualquer',	''),
(3,	'/algum/outro',	'');
...
DROP TABLE IF EXISTS `pages_apis`;
CREATE TABLE `pages_apis` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `page_id` int(11) NOT NULL,
  `api_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `page_id` (`page_id`),
  KEY `api_id` (`api_id`),
  CONSTRAINT `pages_apis_ibfk_1` FOREIGN KEY (`page_id`) REFERENCES `pages` (`id`),
  CONSTRAINT `pages_apis_ibfk_2` FOREIGN KEY (`api_id`) REFERENCES `apis` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `pages_apis` (`id`, `page_id`, `api_id`) VALUES
(1,	1,	1),
(2,	1,	2),
(3,	2,	3);
