...
CREATE TABLE `data` (
  ...
  KEY `api_id` (`api_id`),
  KEY `page_id` (`page_id`),
  CONSTRAINT `data_ibfk_1` FOREIGN KEY (`api_id`) REFERENCES `apis` (`id`),
  CONSTRAINT `data_ibfk_2` FOREIGN KEY (`page_id`) REFERENCES `pages` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `data` (`id`, `api_id`, `page_id`, `data`, `updated_at`, `created_at`) VALUES
(1,	6,	1,	'{\"abc\": \"UM TEXTOAAAAAAAAAAAAAAA\"}',	'2021-05-16 13:35:00',	'2021-05-16 13:35:00'),
(2,	6,	1,	'{\"abc\": \"UM TEXTOAAAAAAAAAAAAAAA\"}',	'2021-05-16 13:35:53',	'2021-05-16 13:35:53'),
(4,	6,	1,	'{\"abc\": \"UM TEXTOAAAAAAAAAAAAAAA\"}',	'2021-05-16 13:44:02',	'2021-05-16 13:44:02'),
(5,	6,	1,	'{\"abc\": \"UM TEXTOAAAAAAAAAAAAAAA\"}',	'2021-05-16 13:44:34',	'2021-05-16 13:44:34'),
(6,	6,	1,	'{\"abc\": \"UM TEXTOAAAAAAAAAAAAAAA\", \"abcd\": \"OUTRO TEXTO\", \"abcde\": \"ALEATORIO\"}',	'2021-05-16 13:45:12',	'2021-05-16 13:45:12'),
(7,	6,	1,	'{\"abc\": \"UM TEXTOAAAAAAAAAAAAAAA\", \"abcd\": \"OUTRO TEXTO\", \"abcde\": \"ALEATORIO\"}',	'2021-05-16 13:45:14',	'2021-05-16 13:45:14'),
(8,	6,	1,	'{\"abc\": \"UM TEXTOAAAAAAAAAAAAAAA\", \"abcd\": \"DWADWADW TEXTO\", \"abcde\": \"DIUHWAHUDIWAUHI\"}',	'2021-05-16 13:45:22',	'2021-05-16 13:45:22'),
(9,	6,	1,	'{\"abc\": \"UM TEXTOAAAAAAAAAAAAAAA\", \"abcd\": \"hoje teste\", \"abcde\": \"domingogo\"}',	'2021-05-16 13:45:34',	'2021-05-16 13:45:34'),
(10,	6,	1,	'{\"abc\": \"UM TEXTOAAAAAAAAAAAAAAA\", \"abcd\": \"hoje teste\", \"abcde\": \"domingogo\"}',	'2021-05-16 14:44:57',	'2021-05-16 14:44:57');
